...
student_01 = Student('Sara', 'Polson', 'female')
student_01.courses_in_progress += ['Python', 'Git']
student_01.finished_courses += ['Discord']

student_02 = Student('Adam', 'Foster', 'male')
student_02.courses_in_progress += ['Python', 'Java']
student_02.finished_courses += ['Git']

reviewer_01 = Reviewer('Dallas', 'Bates')
reviewer_01.courses_attached += ['Python', 'Git', 'Java']

reviewer_02 = Reviewer('Iatan', 'Man')
reviewer_02.courses_attached += ['Python', 'Discord']

lecturer_01 = Lecturer('Dr.', 'Programmer')
lecturer_02 = Lecturer('Mrs.', 'Speaker')


reviewer_01.rate_hw(student_01, 'Python', 50)
reviewer_01.rate_hw(student_02, 'Python', 80)
...
student_02.rate_lect(lecturer_02, 'Python', 3)
